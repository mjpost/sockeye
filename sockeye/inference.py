...
class Translator:
    ...
    def _get_inference_input(self,
        ...
        raw_include_list = [None] * batch_size  # type: List[Optional[constrained.RawConstraintList]]
        ...
        return source, bucket_key, restrict_lexicon, raw_include_list, raw_avoid_list, \
