...
class TransformerDecoderBlock(mx.gluon.HybridBlock):
    ...
    def hybrid_forward(self, F,
        ...
        # self-attention
        target_self_att, _ = self.self_attention(self.pre_self_attention(target, None), None, target_bias, cache)
        target = self.post_self_attention(target_self_att, target)

        # encoder attention
        target_enc_att, attention_probs = self.enc_attention(self.pre_enc_attention(target, None), source, None, source_bias)
